...
<body>
        ...
        <table style="width: 550px; height: 400px">
            ...
            <tr>
                ...
                <td>
                    ...
                    value="${userinfo.address }" style="width: 313px;">
            ...
            <tr>
                <td><b>비밀번호 확인</b></td>
                <td><input class="form-control" type="password" name="passwordCheck"></td>
            </tr>
    ...
    <script>
        // "delUser" 버튼 클릭 이벤트 핸들러
        document.querySelector("#delUser").addEventListener("click",
                function() {
                    window.location.href = "${root}/user?act=logout";
                });
    </script>
