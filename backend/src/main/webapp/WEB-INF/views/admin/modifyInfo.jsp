...
<body>
    ...
    <form id="modifyForm" action="/admin/update/user" method="post">
        <table style="width: 550px; height: 400px">
            ...
            <tr>
                <td><b>아이디</b></td>
                <td><input class="form-control" type="text" name="userId" value="${user.userId}" readonly></td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    </div> <input class="form-control " type="text" id="sample4_roadAddress"
                    placeholder="도로명주소" name="address"
                    value="${user.address}" style="width: 313px;">
                ...
                <td>
                	<c:choose>
            			<c:when test="${user.role eq 'ADMIN'}">
                			<input type="radio" name="role" value="ADMIN" checked> 관리자
                			<input type="radio" name="role" value="USER"> 사용자
            			</c:when>
            			<c:otherwise>
               				<input type="radio" name="role" value="ADMIN"> 관리자
                			<input type="radio" name="role" value="USER" checked> 사용자
            			</c:otherwise>
        			</c:choose>
                </td>
            </tr>
